...
Запуск:  python -m retail_recommender.data.validate
"""
...
from retail_recommender.config import Config, load_config
from retail_recommender.data.load import iter_item_properties, load_category_tree, load_events
